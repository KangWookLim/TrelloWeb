...
public class SignupController {
    ...
    public ModelAndView signup(@Valid SignupForm signupForm, BindingResult bindingResult) {
        ...
        try {
            userSignupService.creat(signupForm.getId(), signupForm.getEMAIL(), signupForm.getPw(),signupForm.getNickname(), signupForm.getFullname(),signupForm.getBIRTH(), signupForm.getBIO());
