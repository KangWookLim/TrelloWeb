    ...
    public void CreateMail(String email, String token){
        ...
        MimeMessagePreparator preparatory = mimeMessage -> {
            ...
            String content = "<!DOCTYPE html>\n" +
                    ...
                    username +
                    ",</a></p><p style=\"font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Fira Sans,Droid Sans,Helvetica Neue,sans-serif;font-size:14px;font-weight:400;letter-spacing:-0.005em;color:#091e42;line-height:20px;margin-top:12px\">" +
                    "To <span class=\"il\">complete </span> sign up to our website please click the button below to continue sign up with <strong><a style=\"text-decoration:none;color:inherit\">" +
                    email +
                    "</a></strong>.</p>" +

                    "<div style=\"margin-top:28px\"><a href=\"http://localhost:8091/signup?token=" +
                    token +
